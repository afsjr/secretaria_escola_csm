...
> Gerado pelo Reversa em 2026-09-07. Este arquivo é o contrato do registro de bugs deste projeto.
...
> Closure policy `local-software` assumida pela rota expressa; confirme na primeira execução completa do /reversa-debugger.
...
└── <contexto>/                  ex.: emissao-documentos-pdf/
