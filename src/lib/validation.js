...
export const notaSchema = z.object({
  ...
  n1: z
    .union([z.string(), z.number()])
    .transform(val => parseFloat(String(val)) || 0)
    .refine(val => val >= 0 && val <= 10, { message: 'Nota deve estar entre 0 e 10' }),
  n2: z
    .union([z.string(), z.number()])
    .transform(val => parseFloat(String(val)) || 0)
    .refine(val => val >= 0 && val <= 10, { message: 'Nota deve estar entre 0 e 10' }),
  ...
  rec: z
    .union([z.string(), z.number()])
    .transform(val => parseFloat(String(val)) || 0)
    .refine(val => val >= 0 && val <= 10, { message: 'Recuperação deve estar entre 0 e 10' })
})
 ...
 */
export function validateTurma(data) {
 ...
 * Validar nota
 */
export function validateNota(data) {
