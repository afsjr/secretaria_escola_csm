# Plano de Exploração — secretaria_escola_csm
...
- [x] **Arqueólogo** — Análise do módulo `academic`
- [x] **Arqueólogo** — Análise do módulo `professor`
- [x] **Arqueólogo** — Análise do módulo `course`
- [x] **Arqueólogo** — Análise do módulo `student`
- [x] **Arqueólogo** — Análise do módulo `documents`
- [x] **Arqueólogo** — Análise do módulo `financeiro`
- [x] **Arqueólogo** — Análise do módulo `audit`
